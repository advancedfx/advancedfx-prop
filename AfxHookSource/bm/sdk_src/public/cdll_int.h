...
#ifndef SOURCESDK_BM_CDLL_INT_H
#define SOURCESDK_BM_CDLL_INT_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
#define SOURCESDK_BM_VENGINE_CLIENT_RANDOM_INTERFACE_VERSION	"VEngineRandom001"

// change this when the new version is incompatable with the old
#define SOURCESDK_BM_VENGINE_CLIENT_INTERFACE_VERSION		"VEngineClient015"
...
//	virtual void _UNKNOWN_100(void) = 0;
	...
	virtual void			_UNKNOWN_109() = 0;
	virtual void			_UNKNOWN_110() = 0;
...
#define SOURCESDK_BM_CLIENT_DLL_INTERFACE_VERSION		"VClient018"
