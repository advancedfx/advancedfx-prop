...
#include <tf2/sdk_src/public/vstdlib/IKeyValuesSystem.h>
...
KeyValues *KeyValues::FindKey(const char *keyName, bool bCreate)
{
	...
	if ( iSearchStr == SOURCESDK_TF2_INVALID_KEY_SYMBOL )
	{
...
KeyValues *KeyValues::CreateNewKey()
{
	...
	char buf[12];
	SOURCESDK_Q_snprintf( buf, sizeof(buf), "%d", newID );
