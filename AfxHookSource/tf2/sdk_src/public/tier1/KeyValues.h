...
#ifndef SOURCESDK_TF2_KEYVALUES_H
#define SOURCESDK_TF2_KEYVALUES_H
...
#define SOURCESDK_TF2_FOR_EACH_SUBKEY( kvRoot, kvSubKey ) \
	for ( KeyValues * kvSubKey = kvRoot->GetFirstSubKey(); kvSubKey != NULL; kvSubKey = kvSubKey->GetNextKey() )

#define SOURCESDK_TF2_FOR_EACH_TRUE_SUBKEY( kvRoot, kvSubKey ) \
	for ( KeyValues * kvSubKey = kvRoot->GetFirstTrueSubKey(); kvSubKey != NULL; kvSubKey = kvSubKey->GetNextTrueSubKey() )

#define SOURCESDK_TF2_FOR_EACH_VALUE( kvRoot, kvValue ) \
...
/*
	...
	bool SaveToFile( IBaseFileSystem *filesystem, const char *resourceName, const char *pathID = SOURCESDK_NULL, bool sortKeys = false, bool bAllowEmptyString = false );
...
*/
	...
	bool GetBool( const char *keyName = SOURCESDK_NULL, bool defaultValue = false, bool* optGotDefault = SOURCESDK_NULL);
...
#define SOURCESDK_TF2_UNPACK_FIXED( kname, kdefault, dtype, ofs ) { kname, kdefault, dtype, ofs, 0 }
#define SOURCESDK_TF2_UNPACK_VARIABLE( kname, kdefault, dtype, ofs, sz ) { kname, kdefault, dtype, ofs, sz }
#define SOURCESDK_TF2_UNPACK_END_MARKER { NULL, NULL, UNPACK_TYPE_FLOAT, 0 }
...
#endif // SOURCESDK_TF2_KEYVALUES_H
