...
{
	AFXADDR_SET(cstrike_CalcDemoViewOverride, clientDll +0x13E6C0);
	AFXADDR_SET(cstrike_CalcDemoViewOverride_DSZ, 0x09);
	AFXADDR_SET(cstrike_CViewRender_SetUpView, clientDll +0x13EF80);
	AFXADDR_SET(cstrike_CViewRender_SetUpView_DSZ, 0x0d);
	AFXADDR_SET(cstrike_cl_demoviewoverride, clientDll +0x596CE4);
	AFXADDR_SET(cstrike_gpGLobals, clientDll +0x52AA44);
