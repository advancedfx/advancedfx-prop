...
#ifndef SOURCESDK_GARRYSMOD_IAPPSYSTEM_H
#define SOURCESDK_GARRYSMOD_IAPPSYSTEM_H
...
//-----------------------------------------------------------------------------
SOURCESDK_abstract_class IAppSystemV0
{
public:
	// Here's where the app systems get to learn about each other 
	virtual bool Connect( CreateInterfaceFn factory ) = 0;
...
#endif // SOURCESDK_GARRYSMOD_IAPPSYSTEM_H
