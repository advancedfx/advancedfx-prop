...
#ifndef SOURCESDK_INSURGENCY2_CDLL_INT_H
#define SOURCESDK_INSURGENCY2_CDLL_INT_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
SOURCESDK_DECLARE_POINTER_HANDLE(LightCacheHandle_t);
...
//-----------------------------------------------------------------------------
#define SOURCESDK_INSURGENCY2_VENGINE_CLIENT_RANDOM_INTERFACE_VERSION	"VEngineRandom001"

// change this when the new version is incompatable with the old
#define SOURCESDK_INSURGENCY2_VENGINE_CLIENT_INTERFACE_VERSION		"VEngineClient014"

//-----------------------------------------------------------------------------
// Purpose: Interface exposed from the engine to the client .dll
//-----------------------------------------------------------------------------
SOURCESDK_abstract_class IVEngineClient
{
public:
	...
	virtual bool				_TODO_GetPlayerInfo() = 0;// int ent_num, player_info_t *pinfo) = 0;
	...
	// Copy current view orientation into va
	virtual void				_TODO_GetFreeAimAngles(QAngle& va) = 0;
	// Set current view orientation from va
	virtual void				_TODO_SetFreeAimAngles(QAngle& va) = 0;
	...
	virtual const char			*_TODO_Key_BindingForKey() = 0;// ButtonCode_t &code) = 0;
	...
	virtual bool				_TODO_CheckDoneKeyTrapping() = 0; //ButtonCode_t &code) = 0;
...
#if !defined( SOURCESDK_INSURGENCY2_NO_VOICE )
	...
	virtual int			_TODO_GetFrustumList() = 0; // Frustum_t **pList, int listMax) = 0;
	...
	virtual void		ComputeLighting(const Vector& pt, const Vector* pNormal, bool bClamp, Vector& color, Vector *pBoxColors = SOURCESDK_NULL) = 0;
	...
	// not avaialble // virtual bool		IsReplay(void) = 0;
	...
	virtual void			StartXboxExitingProcess() = 0; //:126
	...
	virtual void			_UNKNOWN_132() = 0;
	virtual void			_UNKNOWN_133() = 0;
	virtual void			_UNKNOWN_134() = 0;
	virtual void			_UNKNOWN_135() = 0;
	virtual void			_UNKNOWN_136() = 0;
	virtual void			_UNKNOWN_137() = 0;
	virtual void			_UNKNOWN_138() = 0;
	virtual void			_UNKNOWN_139() = 0;
	virtual void			_UNKNOWN_140() = 0;
	virtual void			_UNKNOWN_141() = 0;
	virtual void			_UNKNOWN_142() = 0;


	//Finds or Creates a shared memory space, the returned pointer will automatically be AddRef()ed
	virtual ISPSharedMemory *_TODO_GetSinglePlayerSharedMemorySpace() = 0; // const char *szName, int ent_num = MAX_EDICTS) = 0;

	// Computes an ambient cube that includes ALL dynamic lights
	virtual void ComputeLightingCube(const Vector& pt, bool bClamp, Vector *pBoxColors) = 0; //:144
	...
	virtual void SetMixLayerLevel(int index, float level) = 0; //:159

	virtual void			_UNKNOWN_160() = 0;
	virtual void			_UNKNOWN_161() = 0;
	virtual void			_UNKNOWN_162() = 0;
	virtual void			_UNKNOWN_163() = 0;
	virtual void			_UNKNOWN_164() = 0;
	virtual void			_UNKNOWN_165() = 0;
	virtual void			_UNKNOWN_166() = 0;
	virtual void			_UNKNOWN_167() = 0;
	virtual void			_UNKNOWN_168() = 0;
	virtual void			_UNKNOWN_169() = 0;
	virtual void			_UNKNOWN_170() = 0;
	virtual void			_UNKNOWN_171() = 0;
	virtual void			_UNKNOWN_172() = 0;
	virtual void			_UNKNOWN_173() = 0;

	// How much time was spent in server simulation?
	virtual float	GetServerSimulationFrameTime() const = 0; // 174
	...
	virtual void _TODO_ServerCmdKeyValues() = 0; // KeyValues *pKeyValues) = 0;
...
//-----------------------------------------------------------------------------
//SOURCESDK_abstract_class IBaseClientDLL
//{
//public:
...
#define SOURCESDK_INSURGENCY2_CLIENT_DLL_INTERFACE_VERSION		"VClient016"
...
#endif // SOURCESDK_INSURGENCY2_CDLL_INT_H
