...
#ifndef SOURCESDK_CSGO_ICVAR_H
#define SOURCESDK_CSGO_ICVAR_H
#ifdef _WIN32
#pragma once
#endif
...
public:
	...
	virtual void			RegisterConCommand( ConCommandBase *pCommandBase, int _arg1 = 0) = 0;
