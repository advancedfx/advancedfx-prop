...
#ifndef SOURCESDK_CSS_KEYVALUES_H
#define SOURCESDK_CSS_KEYVALUES_H
...
#define SOURCESDK_CSS_FOR_EACH_SUBKEY( kvRoot, kvSubKey ) \
	for ( KeyValues * kvSubKey = kvRoot->GetFirstSubKey(); kvSubKey != NULL; kvSubKey = kvSubKey->GetNextKey() )

#define SOURCESDK_CSS_FOR_EACH_TRUE_SUBKEY( kvRoot, kvSubKey ) \
	for ( KeyValues * kvSubKey = kvRoot->GetFirstTrueSubKey(); kvSubKey != NULL; kvSubKey = kvSubKey->GetNextTrueSubKey() )

#define SOURCESDK_CSS_FOR_EACH_VALUE( kvRoot, kvValue ) \
