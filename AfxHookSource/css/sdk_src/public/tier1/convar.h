...
#ifndef SOURCESDK_CSSS_CONVAR_H
#define SOURCESDK_CSSS_CONVAR_H
...
#define SOURCESDK_CSS_COMMAND_COMPLETION_MAXITEMS		64
#define SOURCESDK_CSS_COMMAND_COMPLETION_ITEM_LENGTH	64

//-----------------------------------------------------------------------------
// Returns 0 to COMMAND_COMPLETION_MAXITEMS worth of completion strings
//-----------------------------------------------------------------------------
typedef int  ( *FnCommandCompletionCallback )( const char *partial, char commands[ SOURCESDK_CSS_COMMAND_COMPLETION_MAXITEMS ][ SOURCESDK_CSS_COMMAND_COMPLETION_ITEM_LENGTH ] );
...
public:
    ...
    virtual int AutoCompleteSuggest( void * dummy, void * dummy2 );
...
{
	if ( m_nFlags & SOURCESDK_CSS_FCVAR_NEVER_AS_STRING )
...
{
	Assert( !IsFlagSet( SOURECESDK_CSS_FCVAR_NEVER_AS_STRING ) );
