...
#include <css/sdk_src/public/vstdlib/IKeyValuesSystem.h>
...
//-----------------------------------------------------------------------------
bool KeyValues::SaveToFile( IBaseFileSystem *filesystem, const char *resourceName, const char *pathID, bool sortKeys, bool bAllowEmptyString  )
{
	// create a write file
...
KeyValues *KeyValues::FindKey(const char *keyName, bool bCreate)
{
	...
	if ( iSearchStr == SOURCESDK_CSS_INVALID_KEY_SYMBOL )
	{
...
//
bool KeyValues::Dump( IKeyValuesDumpContext *pDump, int nIndentLevel )
{
