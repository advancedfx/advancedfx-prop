...
#ifndef SOURCESDK_CS2_KEYVALUES_H
#define SOURCESDK_CS2_KEYVALUES_H
...
#define SOURCESDK_CS2_KV_BINARY_POOLED_FORMAT 0xAA


#define SOURCESDK_CS2_FOR_EACH_SUBKEY( kvRoot, kvSubKey ) \
	for ( KeyValues * kvSubKey = kvRoot->GetFirstSubKey(); kvSubKey != NULL; kvSubKey = kvSubKey->GetNextKey() )

#define SOURCESDK_CS2_FOR_EACH_TRUE_SUBKEY( kvRoot, kvSubKey ) \
	for ( KeyValues * kvSubKey = kvRoot->GetFirstTrueSubKey(); kvSubKey != NULL; kvSubKey = kvSubKey->GetNextTrueSubKey() )

#define SOURCESDK_CS2_FOR_EACH_VALUE( kvRoot, kvValue ) \
...
#define SOURCESDK_CS2_UNPACK_FIXED( kname, kdefault, dtype, ofs ) { kname, kdefault, dtype, ofs, 0 }
#define SOURCESDK_CS2_UNPACK_VARIABLE( kname, kdefault, dtype, ofs, sz ) { kname, kdefault, dtype, ofs, sz }
#define SOURCESDK_CS2_UNPACK_END_MARKER { NULL, NULL, UNPACK_TYPE_FLOAT, 0 }
...
#endif // SOURCESDK_CS2_KEYVALUES_H