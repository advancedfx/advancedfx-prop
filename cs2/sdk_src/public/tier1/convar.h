...
#define SOURCESDK_CS2_COMMAND_COMPLETION_MAXITEMS		64
#define SOURCESDK_CS2_COMMAND_COMPLETION_ITEM_LENGTH	64

//-----------------------------------------------------------------------------
// Returns 0 to COMMAND_COMPLETION_MAXITEMS worth of completion strings
//-----------------------------------------------------------------------------
typedef int(*FnCommandCompletionCallback)(const char *partial, char commands[SOURCESDK_CS2_COMMAND_COMPLETION_MAXITEMS][SOURCESDK_CS2_COMMAND_COMPLETION_ITEM_LENGTH]);
