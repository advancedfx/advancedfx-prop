...
HL_ADDR_DEF(CLOFS_UnkCstrikeCh_add_fac)
HL_ADDR_DEF(CLOFS_UnkCstrikeCh_mul_fac)
HL_ADDR_DEF(CLOFS_UnkCstrikeCrosshairFn)
...
HL_ADDR_DEF(UpdateSpectatorPanel_checkjmp_ag_clofs)
HL_ADDR_DEF(UpdateSpectatorPanel_checkjmp_ns_clofs)
HL_ADDR_DEF(UpdateSpectatorPanel_checkjmp_tfc)
HL_ADDR_DEF(UpdateSpectatorPanel_checkjmp_valve)
HL_ADDR_DEF(hw_dll)
HL_ADDR_DEF(cstrike_EV_CreateSmoke_CLOFS)
