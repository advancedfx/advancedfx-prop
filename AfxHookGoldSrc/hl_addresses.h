...
HL_ADDR_EXPOSE(ClientFunctionTable)
...
HL_ADDR_EXPOSE(R_DrawSkyBoxEx)
HL_ADDR_EXPOSE(R_DrawSkyBoxEx_DSZ)
...
HL_ADDR_EXPOSE(cstrike_UnkCrosshairFn)
HL_ADDR_EXPOSE(cstrike_UnkCrosshairFn_DSZ)
HL_ADDR_EXPOSE(cstrike_UnkCrosshairFn_add_fac)
HL_ADDR_EXPOSE(cstrike_UnkCrosshairFn_mul_fac)
