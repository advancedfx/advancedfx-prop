...
AFXADDR_DEF(CL_ParseServerMessage)
AFXADDR_DEF(CL_ParseServerMessage_CmdRead)
AFXADDR_DEF(ClientFunctionTable)
AFXADDR_DEF(DTOURSZ_CL_ParseServerMessage_CmdRead)
AFXADDR_DEF(DTOURSZ_GetClientColor)
...
AFXADDR_DEF(DTOURSZ_SCR_UpdateScreen)
AFXADDR_DEF(DTOURSZ_SND_PickChannel)
AFXADDR_DEF(DTOURSZ_S_PaintChannels)
AFXADDR_DEF(DTOURSZ_S_TransferPaintBuffer)
AFXADDR_DEF(DTOURSZ_UnkGetDecalTexture)
AFXADDR_DEF(GetClientColor)
AFXADDR_DEF(GetSoundtime)
AFXADDR_DEF(HUD_TOURIN)
AFXADDR_DEF(HUD_TOUROUT)
...
AFXADDR_DEF(SCR_UpdateScreen)
AFXADDR_DEF(SND_PickChannel)
AFXADDR_DEF(SZ_unkInlineClientColorA)
AFXADDR_DEF(SZ_unkInlineClientColorV)
AFXADDR_DEF(S_PaintChannels)
AFXADDR_DEF(S_TransferPaintBuffer)
AFXADDR_DEF(UnkGetDecalTexture)
AFXADDR_DEF(UnkDevCapsChecks)
AFXADDR_DEF(UnkDevCapsChecks_BYTES)
...
AFXADDR_DEF(net_message_cursize)
...
AFXADDR_DEF(unkInlineClientColorA)
AFXADDR_DEF(unkInlineClientColorV)
