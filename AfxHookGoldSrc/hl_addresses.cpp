...
HL_ADDR_DEF(ClientFunctionTable)
...
HL_ADDR_DEF(R_DrawSkyBoxEx)
HL_ADDR_DEF(R_DrawSkyBoxEx_DSZ)
...
HL_ADDR_DEF(cstrike_UnkCrosshairFn)
HL_ADDR_DEF(cstrike_UnkCrosshairFn_DSZ)
HL_ADDR_DEF(cstrike_UnkCrosshairFn_add_fac)
HL_ADDR_DEF(cstrike_UnkCrosshairFn_mul_fac)
