	...
	_T("Half-Life Advanced Effects - Launcher"), wxDefaultPosition, wxSize(410,402))
{
	...
	st_presets = new wxStaticText( this, wxID_ANY, _T("Presets:"), wxDefaultPosition, wxDefaultSize, 0 );
	st_presets->Wrap( -1 );
	st_presets->Enable( false );
	
	bs_presets->Add( st_presets, 0, wxALIGN_CENTER_VERTICAL, 5 );
	
	m_cb_preset = new wxComboBox( this, wxID_ANY, _T("Default"), wxDefaultPosition, wxDefaultSize, 0, NULL, 0 ); 
	m_cb_preset->Enable( false );
	
	bs_presets->Add( m_cb_preset, 1, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );
	
	wxButton* bt_save;
	bt_save = new wxButton( this, ID_SavePreset, _T("Save"), wxDefaultPosition, wxDefaultSize, 0 );
	bt_save->Enable( false );
	
	bs_presets->Add( bt_save, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );
	
	wxButton* bt_delete;
	bt_delete = new wxButton( this, ID_DeletePreset, _T("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbs_game = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _T("Game") ), wxVERTICAL );
	...
	st_path = new wxStaticText( this, wxID_ANY, _T("Half-Life Directory:"), wxDefaultPosition, wxDefaultSize, 0 );
	st_path->Wrap( -1 );
	...
	wxButton* bt_browse;
	bt_browse = new wxButton( this, ID_Browse, _T("..."), wxDefaultPosition, wxSize( -1,-1 ), wxBU_EXACTFIT );
	bs_path->Add( bt_browse, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );
	
	fgs_game->Add( bs_path, 0, wxEXPAND, 5 );
	
	wxStaticText* st_mod;
	st_mod = new wxStaticText( this, wxID_ANY, _T("Modification:"), wxDefaultPosition, wxDefaultSize, 0 );
	st_mod->Wrap( -1 );
	...
	st_custommod = new wxStaticText( this, wxID_ANY, _T("Custom:"), wxDefaultPosition, wxDefaultSize, 0 );
	st_custommod->Wrap( -1 );
	...
	sbs_res = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _T("Resolution") ), wxHORIZONTAL );
	...
	m_ch_force = new wxCheckBox( this, ID_Changed, _T("Force"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	st_width = new wxStaticText( this, wxID_ANY, _T("Width:"), wxDefaultPosition, wxDefaultSize, 0 );
	st_width->Wrap( -1 );
	...
	st_height = new wxStaticText( this, wxID_ANY, _T("Height:"), wxDefaultPosition, wxDefaultSize, 0 );
	st_height->Wrap( -1 );
	...
	st_depth = new wxStaticText( this, wxID_ANY, _T("Color Depth:"), wxDefaultPosition, wxDefaultSize, 0 );
	st_depth->Wrap( -1 );
	...
	st_depthcustom = new wxStaticText( this, wxID_ANY, _T("Custom:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbs_cmdline = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _T("Commandline") ), wxVERTICAL );
	...
	st_additionalcmdline = new wxStaticText( this, wxID_ANY, _T("Additional:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	st_fullcmdline = new wxStaticText( this, wxID_ANY, _T("Full:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	wxButton* bt_ok;
	bt_ok = new wxButton( this, ID_Launch, _T("Launch"), wxDefaultPosition, wxDefaultSize, 0 );
	bt_ok->SetDefault(); 
	bs_dglbuttons->Add( bt_ok, 0, wxALIGN_RIGHT, 5 );
	
	wxButton* bt_cancel;
	bt_cancel = new wxButton( this, wxID_CANCEL, _T("Cancel"), wxDefaultPosition, wxDefaultSize, 0 );
